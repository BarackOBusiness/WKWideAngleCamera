...
## Features
- Very wide FOV (in horizontal degrees), via four distinct camera projections, see below
...
Equidistant and equisolid projection gallery additions will be made at some point.™ If I don't get to it however, feel free to submit your own gameplay
on the Wide Angle Camera thread of #modding-releases in the white knuckle discord if you feel something is a good candidate to be featured here
...
I've made [this calculator](https://www.desmos.com/calculator/awebrw5jve) to plug in your display parameters and get a corresponding number for comparison (some of this only applies to stereographic projection for now)
